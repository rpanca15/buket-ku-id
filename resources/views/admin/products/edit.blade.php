            ...
            <div class="flex-1 flex flex-col gap-6 bg-white shadow-lg rounded-lg p-6">
                ...
                <div class="flex justify-between mt-4">
                    <button type="submit" title="Simpan"
                        class="w-[64px] bg-blue-600 text-white py-3 rounded-full hover:bg-blue-700 transition w-24">
                        <i class="fas fa-save"></i>
                    </button>
                    <button type="reset" title="Reset"
                        class="w-[64px] bg-red-600 text-white py-3 rounded-full hover:bg-red-700 transition w-24">
