...
<div class="container mx-auto px-4 py-4">
    ...
    <form id="product-form" class="flex flex-wrap gap-4" action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="flex-1 bg-white shadow-lg rounded-lg p-6">
            ...
            <div id="image-dropzone" class="dropzone border-dashed border-2 border-gray-300 rounded-lg p-4 bg-gray-50"></div>
            @error('image')
