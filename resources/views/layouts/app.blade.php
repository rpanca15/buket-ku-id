...
<body>
    <nav class="px-10 mt-2.5 max-md:px-5 max-w-screen">
        <div class="flex gap-8 justify-between items-center mx-auto">
            ...
            <ul class="flex gap-6 items-center text-base">
            ...
            @guest
                <div class="flex gap-4 items-center justify-center">
                    <a href="{{ route('login') }}" title="Login"
                        class="text-violet-700 rounded hover:text-violet-800 transition ease-in-out duration-300">
            ...
            @auth
                <div class="flex gap-4 items-center jusitfy-center">
                    <a href="{{ route('admin') }}" title="Cart"
                        class="text-violet-800 rounded hover:text-violet-700 transition ease-in-out duration-300">
                ...
                <form action="{{ route('logout') }}" method="POST" class="inline">
                    ...
                    <button type="submit" title="Logout"
                        class="text-red-500 rounded-lg hover:text-red-600 transition ease-in-out duration-300 relative group">
                        <i class="fas fa-sign-out-alt text-2xl flex opacity-100 group-hover:opacity-0"></i>
                        <i class="fas fa-person-running text-2xl absolute left-0 top-0 opacity-0 group-hover:opacity-100  transition ease-in-out duration-300"></i>
                    </button>
                </form>
            @endauth
        </div>
